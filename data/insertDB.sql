...
insert into LesSpectacles(noSpec, nomSpec, prixBaseSpec) values (3, 'Fast and furious', 50);
...
insert into LesRepresentations_base(noSpec, dateRep, promoRep) values (3, '08/12/2019 18:00', 0.85);


insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 1, 1, '23/12/2019 21:30:20', 'normal',1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 2, 1, '23/12/2019 21:30:20','adh́erent', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 3, 1, '23/12/2019 21:30:20','adh́erent', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 4, 1, '23/12/2019 21:30:20','adh́erent', 1);
...
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 1, 2, '20/12/2019 22:31:00','etudiant', 2);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 2, 2, '20/12/2019 22:31:00','etudiant', 2);
...
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 2, 3, '20/12/2019 14:22:00','normal',3);

insert into LesCategoriesTickets(libelleCat, tauxReductionCat) values ('normal', 1);
insert into LesCategoriesTickets(libelleCat, tauxReductionCat) values ('adh́erent', 0.9);
insert into LesCategoriesTickets(libelleCat, tauxReductionCat) values ('senior', 0.9);
insert into LesCategoriesTickets(libelleCat, tauxReductionCat) values ('etudiant', 0.8);
insert into LesCategoriesTickets(libelleCat, tauxReductionCat) values ('militaire', 0.7);