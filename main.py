...
from actions.action_fct_comp_4 import AppFctComp4_1
from actions.action_tache_1 import AppTache_1
from actions.action_tache_2 import AppTache_2
...
class AppWindow(QMainWindow):
    ...
    def open_tache_1(self):
        if self.tache_1_dialog is not None:
            self.tache_1_dialog.close()
        self.tache_1_dialog = AppTache_1(self.data)
        self.tache_1_dialog.show()
        self.changedValue.connect(self.tache_1_dialog.refreshResult)

    def open_tache_2(self):
        if self.tache_2_dialog is not None:
            self.tache_2_dialog.close()
        self.tache_2_dialog = AppTache_2(self.data)
        self.tache_2_dialog.show()
        self.changedValue.connect(self.tache_2_dialog.refreshResult)
